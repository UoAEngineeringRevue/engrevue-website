...
export class RevueData extends Component {
    ...
    state = {
        coverPicture : this.getCoverPicture(this.year),
        bigPicture : this.getCastPicture(this.year),
        title : this.getTitle(this.year),
        subtitle : this.getSubTitle(this.year),
        catchPhrase : this.getCatchPhrase(this.year),
        location : this.getLocation(this.year),
        director : this.getDirector(this.year),
        producer : this.getProducer(this.year),
        blurb : this.getBlurb(this.year),
        quote : this.getQuote(this.year),
        subquote : this.getSubQuote(this.year)
    }
